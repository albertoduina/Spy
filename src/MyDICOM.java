...
public class MyDICOM extends ImagePlus  {
	...
	*/
	...
	public void run(String arg) {
		...
		MyLog.waitHere();
		OpenDialog od = new OpenDialog("Open MyDicom...", arg);
