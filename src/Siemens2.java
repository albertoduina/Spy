...
public class Siemens2 implements PlugIn {
	 ...
	 * 0029,1020. Questo Tag non e'conosciuto da ImageJ, ma alla fine questo poco
	 * importa, tanto alla fine si tratta di fare una ricerca su di una stringa
	 * contenente tutta l'header Dicom o giu' di li'
	 * 
	 */
	public void run(String arg) {
		...
		try {
			...
			int fromIndex = 1;
			int index3 = header.indexOf("<XProtocol>", fromIndex);
			int index1 = header.indexOf("### ASCCONV BEGIN", fromIndex + 1);
			int index2 = header.indexOf("ASCCONV END ###", fromIndex + 2);
			String blob = "";
			...
			while ((index1 > 0) && (index2 > 0)) {
				...
				IJ.log(blob);
				fromIndex = index2;
				index3 = header.indexOf("<XProtocol>", fromIndex);
				index1 = header.indexOf("### ASCCONV BEGIN", fromIndex + 1);
				index2 = header.indexOf("ASCCONV END ###", fromIndex + 2);
			}
